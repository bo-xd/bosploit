...
struct Fabric1215Mappings {
    static void setup() {
        ...
        Mapping::RegisterClass("EntityPlayerSP", "net.minecraft.class_746");
        ...
        Mapping::RegisterMethod("Minecraft", "getConnection", "method_1562", "()Lnet/minecraft/class_634;", false);
        Mapping::RegisterField("Minecraft", "player", "field_1724", "Lnet/minecraft/class_746;");
    }
};