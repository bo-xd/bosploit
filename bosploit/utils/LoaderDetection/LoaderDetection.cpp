#include "LoaderDetection.h"
#include <iostream>

ModLoader LoaderDetection::DetectModLoader(ClassLoader* classLoader) {
...
bool LoaderDetection::HasClass(ClassLoader* classLoader, const std::string& className) {
