...
public:
    ...
    static void RegisterMethod(const std::string& classLogicalName,
        ...
        const bool isStatic);
    static void RegisterField(const std::string& classLogicalName,
    ...
    static jfieldID GetField(const std::string& classLogicalName, const std::string& fieldLogicalName);
private:
    static JNIEnv* env;
    ...
    static std::unordered_map<std::string, std::unordered_map<std::string, FieldInfo>> fields;
    static void CacheMethodIds();
    static void CacheFieldIds();
};